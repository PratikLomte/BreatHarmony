...
import com.catalystmedia.half_life.*
...
class NotificationUtil {
    companion object{
        ...
        fun showTimerExpired(context: Context){
            ...
            nBuilder.setContentTitle("Meditation Timer Expired!")
                .setContentText("Start Again?")
                .setContentIntent(getPendingIntentWithStack(context, TimerActivity::class.java))
                .addAction(R.drawable.ic_pause, "Start", startPendingIntent)
        ...
        fun showTimerRunning(context: Context, wakeUpTime: Long){
            ...
            val nBuilder = getBasicNotificationBuilder(context, CHANNEL_ID_TIMER, true)
            nBuilder.setContentTitle("Meditation Timer is Running")
        ...
        fun showTimerPaused(context: Context){
            ...
            nBuilder.setContentTitle("Timer is paused.")
                ...
                .setContentIntent(getPendingIntentWithStack(context, TimerActivity::class.java))
                .setOngoing(true)
                .addAction(R.drawable.ic_pause, "Resume", resumePendingIntent)
